...
\begin{document}
	...
	%Chercher ce qui motive à utiliser ces méthodes pour justifier le fait qu'on en parle ici.
	...
	\paragraph{}
	Pour plus de détails sur la propagation, voir le chapitre 7 de \cite{Achterberg2007a} sur \text{Domain propagation}.
